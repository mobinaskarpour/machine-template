      ...
      <div className="px-5 py-8 md:px-10 max-w-[1100px] mx-auto pb-28">
        ...
        >
          ...
          <p className="mt-3 max-w-2xl text-[15px] text-text-secondary leading-relaxed">
            هر گردش‌کار یک مشکل تکراری کسب‌وکار را استاندارد می‌کند. برای نقشه
            فرآیند و ذی‌نفعان، وارد گردش‌کار شوید.
          </p>
          <p className="mt-2 text-[13px] text-text-tertiary">
            {toPersianDigits(orgWorkflows.length)} گردش‌کار در سازمان
          </p>
        </motion.header>

        {proposed.length > 0 && (
          <section className="mb-10 rounded-[14px] border border-primary/25 bg-primary-soft/40 px-5 py-4">
            ...
            >
              <div className="flex items-start justify-between gap-3">
                <div className="flex items-center gap-2.5">
                  <span className="flex h-9 w-9 items-center justify-center rounded-[10px] border border-primary/30 bg-primary-soft text-primary">
              ...
              <p className="mt-4 inline-flex items-center gap-1.5 text-[13px] text-primary">
